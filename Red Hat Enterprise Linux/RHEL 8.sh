...
echo "ls -ld $(awk -F: '($3>=1000)&&($7 !~ /nologin/){print $6}' /etc/passwd)"
ls -ld $(awk -F: '($3>=1000)&&($7 !~ /nologin/){print $6}' /etc/passwd)
echo "grep $(grep svrdgs /etc/passwd | awk -F: '{print $4}') /etc/group"
grep $(grep svrdgs /etc/passwd | awk -F: '{print $4}') /etc/group
echo "----------------------------------------------------------------------------------------------------------------------------------------------------------"
...
echo "RHEL-08-010770"
echo "ls -al /home/dmz/svrdgs.[^.]* | more"
ls -al /home/dmz/svrdgs.[^.]* | more
echo "----------------------------------------------------------------------------------------------------------------------------------------------------------"
...
echo "RHEL-08-010731"
echo "ls -lLR /home/dmz/svrdgs"
ls -lLR /home/dmz/svrdgs
echo "----------------------------------------------------------------------------------------------------------------------------------------------------------"
