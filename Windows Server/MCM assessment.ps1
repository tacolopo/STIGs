$outputFileName = "windowsserver_assessment_complete_data.txt"
$directoryPath = "C:\WinServerTier3"
...
#change to your username
$filePath = "C:\windowsserver_assessment_complete_data.txt"

$content = Get-Content $filePath
$stringCount = @{}

foreach ($line in $content) {
	if ($line -match "^(FFOX|WN12|WN16|WN19|WN22|EDGE)-[A-Za-z0-9]{2}-\d{6}") {
		$match = $matches[0]
